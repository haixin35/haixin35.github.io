...
console.log(kitty.sleeping);
// variable name that is not declared gives an error
// a undeclared parameter of an objet gives undefined and no error

kitty.lives++;
console.log(kitty);

kitty.two = 'two'; // objects are changeable and muteable (you can add to them after they are created)
console.log(kitty);
